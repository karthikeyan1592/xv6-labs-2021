...
/*
1. Read arg using argaddr
2. Read num_pages using argint
3. Add PTE_A in riscv.h
4. set 'PTE_A' for pte whenever it is accessed in walk
5. Add macro to filter PTE_A from pte
6. when pgaccess called, check for the bit in all requested pages and set bit mask
*/
#ifdef LAB_PGTBL
int
sys_pgaccess(void)
